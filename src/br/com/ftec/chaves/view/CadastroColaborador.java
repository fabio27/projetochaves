...
public class CadastroColaborador extends javax.swing.JFrame {
    ...
    private void montaTabelaColaborador() throws ClassNotFoundException, SQLException {
        ...
        for (Colaborador r : dao.listaColaboradores()) {//for(int a=0;a<= listaReservas.size();
